...
from .cpu.sda_cpu import _sda_cpu_naive, _sda_cpu_loop_reordered, _sda_cpu_loop_tiling, _sda_cpu_loop_tiling_SIMD, _sda_cpu_loop_tiling_SIMD_online_softmax_parallel
    ...
    def execute[target: StaticString, flag: Int](
        ...
        comptime if target == "cpu":
            ...
            if flag == 0:
                ...
                _sda_cpu_loop_tiling_SIMD_online_softmax_parallel(output, Q, K, V)
            else:
